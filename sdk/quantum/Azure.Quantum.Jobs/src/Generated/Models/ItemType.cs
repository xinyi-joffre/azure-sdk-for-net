...
namespace Azure.Quantum.Jobs.Models
{
    ...
    internal readonly partial struct ItemType : IEquatable<ItemType>
    {
        ...
        /// <summary> A program, problem, or application submitted for processing. </summary>
        public static ItemType Job { get; } = new ItemType(JobValue);
        /// <summary> A logical grouping of jobs. </summary>
        public static ItemType Session { get; } = new ItemType(SessionValue);
